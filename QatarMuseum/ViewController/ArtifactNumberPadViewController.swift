...
//            view.window!.layer.add(transition, forKey: kCATransition)
    ...
    func getnumberSearchDataFromServer(searchString : String?)
    {
        ...
        _ = Alamofire.request(QatarMuseumRouter.CollectionByTourGuide(["artifact_number": searchString!])).responseObject { (response: DataResponse<TourGuideFloorMaps>) -> Void in
